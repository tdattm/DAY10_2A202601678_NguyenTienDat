...
from retrieval.embeddings import OpenAITextEmbeddings
...
class LocalEmbeddingIndex:
    def __init__(
        ...
        self.embedding_model = OpenAITextEmbeddings(settings.embedding_model, settings.embedding_api_key)
    ...
    def build(
        ...
        embedding_model = OpenAITextEmbeddings(settings.embedding_model, settings.embedding_api_key)
